<html>
    ...
    <p class="top_links"><a href="index.html" class="topLink">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="productSearch.html" class="topLink">Product Search</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="order.html" class="topLink">Order</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="orderLookup.html" class="topLink">Order Look-Up</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="admin.html" class="topLink">Admin</a></p>
        <?php
            ...
            if(!isset($plu) || !isset($method) || !isset($addy) || !isset($name) || trim($name) == "" || trim($plu) == "" || trim($method) == "" || trim($addy)=="") {
            ...
            elseif (preg_match("/^[0-9]{12}$/", $plu) !== 1) {
                ...
                if ($check_item_result === false || $check_item_result->num_rows == 0){
                    ...
                    while ($counter < 16) {
                        ...
                        if (rand() % 8 == 0 || $counter == 15) {
                            $order_exists_query = "SELECT * FROM Customer as c WHERE Purchase_Key=\"".$purchase_key."\";";
                            $order_exists = $mysqli_conn->query($order_exists_query);
                            
                            if ($order_exists === false || $order_exists->num_rows == 0) {
                                break;
                            }
                            else {
                                $counter = 0;
